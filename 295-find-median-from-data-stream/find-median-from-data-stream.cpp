class MedianFinder {
    priority_queue<long long,vector<long long>,less<long long>> smallHeap; //maxheap
        priority_queue<long long, vector<long long>, greater<long long>>largeHeap; //minHeap
public:
    MedianFinder() {
